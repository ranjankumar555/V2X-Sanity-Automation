"""SSH-backed V2X test wrapper.

This wrapper inherits the existing V2X test workflow and adds SSH transport
...
from tests.test_v2x import V2XTest


class SSHV2XTest(V2XTest, SSHTestBase):
    def __init__(
        self,
        test_name: str,
        log_file: str,
